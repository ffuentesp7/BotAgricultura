...
class Recomendacion():
    ...
    def recomendacion(self):
        ...
        etc = Hargreaves.calcularEvotranspiracion(self.mes, self.latitud)

        etcmmsemana = CuantoRegar.cuantoRegar(self.tipoDeCultivo, self.etapaDeCultivo, etc)
        ...
        respuesta = [etc,riegoBotadoFrecuencia, riegoBotadoTiempo, riegoGoteoFrecuencia, riegoGoteoTiempo]
        return respuesta